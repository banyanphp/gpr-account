<div id="sidebar" class="sidebar">
  ...
  <div data-scrollbar="true" data-height="100%">
    ...
    <ul class="nav">
	  ...
	  <li class="has-sub <?php if($page_id == "employee") { echo "active"; } ?>">
        <a href="#">
        <i class="fa fa-user"></i>
        <span>Employee</span>
        </a>
        <ul class="sub-menu">
          ...
          <li><a href="employee_manage.php">Employee Manage</a></li>
          <li><a href="branch.php">Branch Manage</a></li>
        </ul>
      </li>
      ...
      <li class="has-sub <?php if($page_id == "account") { echo "active"; } ?>">
        ...
        <ul class="sub-menu">
		  ...
		  <li><a href="searchbydate.php">Reports by Date</a></li>
