<?php
  ...
  global $database, $db;
  $sel     = "SELECT * from `" . TBL_CREDIT . "` Where customername='" . $_GET['customername'] . "'";
      ...
      <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
          ...
          <ol class="breadcrumb pull-right">
            ...
            <li class="active">Credit Update</li>
          </ol>
          <!-- end breadcrumb -->
          <!-- begin page-header -->
          <h1 class="page-header">Credit Update</h1>
          <!-- end page-header -->
          <?php
            if ($_SESSION["msg"] != "") {
            ?>
            ...
            <div class="col-md-12">
              ...
              <div class="panel panel-inverse">
                <div class="panel-heading">
                  <h4 class="panel-title"><i class="fa fa-inr"></i> Credit Update</h4>
                </div>
                <div class="panel-body">
                  <form action="credit_update.php" method="post" name="credit" id="credit">
                    <!-- begin row -->
                    <div class="row">
                      <div class="col-md-12">
                    ...
                    <div class="row">
                      <div class="col-md-12">
                        <input type="text" class="form-control" name="type" value="<?php
                          echo $row['type'];
                          ?>" id="type" placeholder="TYPE" disabled>
                      </div>
                    </div>
                    <!-- end row -->
                    <div class="clearfix">
