...
$sel = "SELECT * from `" . TBL_CREDIT . "` Where customername='" . $customername . "'";
...
$advance = $row['crlimit'];
$adv = $advance - $tckt;
$qry_update = "UPDATE  `" . TBL_CREDIT . "` SET crlimit='" . $adv . "'+ '" . $towards . "',created_dt='" . $date . "' WHERE customername='" . $customername . "';";
$result_upload = $database->query($qry_update);

if ($result_upload > 0)
	{
	$_SESSION["msg"] = "Upadate successfully!.";
	redirect_to('credit_manage.php');
	}
  else
	{
