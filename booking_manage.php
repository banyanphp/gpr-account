              ...
              <div class="panel panel-inverse">
                ...
                <div class="panel-body">
                  <div class="col-md-12">
                    <blockquote>
                      <?php
                        $sel="SELECT btype,SUM(tcktamount) from `".TBL_BOOKING."` WHERE created_dt='". date("Y-m-d") ."' AND branch_idfk='". $_SESSION['branch'] ."' GROUP BY btype";
                    ...
                    <div class="table-responsive">
                      <table id="data-table" class="table table-striped table-bordered">
                        ...
                        <tbody>
                          <?php 
                            $j=1;
                            $sel="SELECT * from `".TBL_BOOKING."`WHERE created_dt='". date("Y-m-d") ."' AND branch_idfk='". $_SESSION['branch'] ."'";
                            $result = $database->query($sel);
                            while($row = $database->fetch_array($result))
